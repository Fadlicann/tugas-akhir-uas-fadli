                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Edit Data Mahaiswa</h3>
                        </div>
                            ...
                            <form action="/siswa/{{ $siswa->id }}/update" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="nama_depan" type="text" class="form-control" id="nama_depan"
                                        aria-describedby="emailHelp" required value="{{ $siswa->nama_depan }}">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="alamat" class="form-control" name="alamat" id="alamat" rows="3" required>{{ $siswa->alamat }}</textarea>
                                </div>
